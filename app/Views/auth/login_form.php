      ...
      <div class="row g-0">
        <div class="col-lg-6 p-5 login-left">
          ...
          <div class="position-relative" style="z-index:2">
            ...
            <img src="<?= base_url('/img/illustration.png') ?>" alt="Ilustrasi" class="img-fluid" style="max-height: 260px; height: 260px;">
          </div>
        </div>
          ...
          <form action="<?= base_url('/auth/login') ?>" method="POST" autocomplete="on">
            ...
            <div class="mb-2">
              ...
              <div class="input-group" id="passwordGroup">
                ...
                <button class="btn btn-outline-secondary" type="button" id="togglePassword" tabindex="-1"><i class="lni lni-eye"></i></button>
              </div>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
              ...
              <a class="small" href="#" onclick="alert('Hubungi admin untuk reset password.'); return false;">Lupa password?</a>
            </div>
